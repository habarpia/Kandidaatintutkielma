...
\\
Mikäli kurssilla on paljon opiskelijoita ja henkilökuntaa, ohjaajamalli tarvitsee usein toimiakseen jonkinlaisen koordinaattorin. Koordinaattori voi olla esimerkiksi opinnoissaan pitkälle edennyt opiskelija, joka on aiemmin toiminut ryhmänohjaajana. Koordinaattoreita voi tarpeen tullen olla useampia.\cite{Roberts95}
\\
Koordinaattorin tehtäviin kuuluu kurssin käytännön hallinnointi, eli esimerkiksi luokkahuoneiden varaaminen ja tarvittavien ohjaajien jakaminen kursseille. Koordinaattorit myös hoitavat ohjaajien valinnan ja palkkaamisen. Heidän tehtäviinsä kuuluu järjestää viikottainen tapaaminen kurssin henkilökunnalle, jotta luennoitsija saa kuvan opiskelijoiden etenemisestä. Viikkopalaverissa ohjaajat voivat kertoa mahdollisista ongelmista, ja luennoitsija voi tarpeen tullen hidastaa tahtia tai selittää jonkin epäselväksi jääneen asian uudestaan paremmin. Palaverissa ohjaajat pääsevät tapaamaan toisiaan ja jakamaan tietoa. Koordinaattorien kuluu ylläpitää tiedon kulkua ja kommunikointia kurssilla. Koordinaattorien kuuluu myös järjestää tapaamisia, joissa käydään läpi opetukseen liittyviä asioita.\cite{Roberts95} Koordinaattori voi huomauttaa ohjaajan puutteellisesta toiminnasta.\cite{Reges88}
