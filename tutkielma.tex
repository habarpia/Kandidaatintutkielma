...
\abstract{
Tietojenkäsittelytieteen alkeiskurssien opetuksen tarve on kasvanut ja opetuksen sisältöön on tullut muutoksia. Resurssien puute ja suuriin luentokursseihin liittyvät ongelmat voivat laskea opetuksen tasoa. \par

Käyttämällä opiskelijoita ohjaajina opetuksen laatua voi nostaa ilman, että kustannukset kohoavat. Ohjaajia voi käyttää erilaisiin työtehtäviin, kuten viikoittaisten keskustelusessioiden johtamiseen, tehtävien tarkistamiseen tai neuvonnan antamiseen. Taloudellisten ja opetuksen laatuun liittyvien hyötyjen lisäksi ohjaajilla on myönteinen vaikutus kurssin ja yliopiston ilmapiiriin, ja ohjaajat saavat toiminnastaan hyödyllistä kokemusta.
}
...
Kolmas ratkaisu ongelmaan on hyödyntää opiskelijoita opetuksessa. Monet yliopistot ovat päättäneet hyödyntää opiskelijoita kurssien opetukseen, sillä he ovat halvempia kuin pitkälle koulutettu työvoima. Taloudellisen edun lisäksi opiskelijoiden on havaittu olevan hyödyllisiä monella muullakin tavalla, sillä opiskelijoiden käytön ohjaajina on muun muassa nostavan opetuksen laatua ja parantavan kurssin ilmapiiriä. \par

Tässä artikkelissa käsittelemme opiskelijoiden hyödyntämistä tie\-to\-jen\-kä\-sit\-te\-ly\-tie\-teen opetuksessa. Esittelemme, millä tavoin opiskelijoita voi käyttää alkeiskurssien ohjaajina, mitä työtehtäviä heillä tyypillisesti on ja millaista organisaatiota opiskelijoiden käyttöminen ohjaajina vaatii. Käsittelemme myös, mitä hyötyjä ja haasteita opiskelijoiden käyttämisestä on. \par
