...
Käyttämällä opiskelijoita ohjaajina opetuksen laatua voi nostaa ilman, että kustannukset kohoavat. Opiskelijoita voi käyttää erilaisiin työtehtäviin, kuten viikoittaisten keskustelusessioiden johtamiseen, tehtävien tarkistamiseen tai neuvonnan antamiseen. Taloudellisten ja opetuksen laatuun liittyvien hyötyjen lisäksi ohjaajilla on myönteinen vaikutus kurssin ja yliopiston ilmapiiriin, ja ohjaajat saavat toiminnastaan hyödyllistä kokemusta esiintymisestä, opettamisesta ja erilaisten ihmisten kanssa työskentelemisestä.
}
